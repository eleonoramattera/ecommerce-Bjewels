package com.example.RegisterLoginLogout.security.service;
...
import com.example.RegisterLoginLogout.security.exception.MyAPIException;
...
import com.example.RegisterLoginLogout.security.repository.RoleRepository;
import com.example.RegisterLoginLogout.security.repository.UserRepository;
import com.example.RegisterLoginLogout.security.security.JwtTokenProvider;
